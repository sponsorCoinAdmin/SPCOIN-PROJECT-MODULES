...
<b>Package SPCOIN-PROJECT-MODULES ©</b> 
...
- <b>https://github.com/sponsorCoinAdmin/SPCOIN-PROJECT-MODULES</b>
...
- Purpose: SPCOIN-PROJECT-MODULES is a WIP GUI front end package to demonstrate blockchain connectivity and transactions.
- Description: SPCOIN-PROJECT-MODULES package is a front end GUI package mimicking Uniswap's appearance and utilizing Uniswap’s SDK
-
...
- Change your current directory to {root installaction}/SPCOIN-PROJECT-MODULES
...
- A sample configuration file <b>.env</b> exists in  project's home directory <b>/Breadcrumbs      SPCOIN-PROJECT-MODULES</b>.
...
- Further environment settings exist in the file <b>/Breadcrumbs      SPCOIN-PROJECT-MODULES/env/.e</b>.
 - - - - 
### Command Menu Shortcuts<img src="https://github.com/sponsorCoinAdmin/spCoinImages/blob/main/menu 4.jpg" width="7%" align= "right">
The <b>All Command Menus</b> are a list of shortcut alias commands for administering the [<b>'Breadcrumbs      SPCOIN-PROJECT-MODULES'</b>](https://github.com/sponsorCoinAdmin/Breadcrumbs      SPCOIN-PROJECT-MODULES/tree/main) project.
...
The above menu is simply a menu of many submenus. Each entry is an alias to an alternate command menu short cut. Each submenu exists under the repositories’ Breadcrumbs      SPCOIN-PROJECT-MODULES/env directory. These menus cane be more completely described in the file [<b>./setupEnv/ReadMe.md</b>](https://github.com/sponsorCoinAdmin/spCoinSetupEnv/blob/main/README.md).

- - - -
### Package Contents<img src="https://github.com/sponsorCoinAdmin/spCoinImages/blob/main/contents.png" width="6%" align= "right">
- [<b>README.md</b>](https://github.com/sponsorCoinAdmin/Breadcrumbs      SPCOIN-PROJECT-MODULES/edit/main/README.md) ~ The Readme Documentation is this documentation.
- [<b>./scripts/spCoinSetup.sh</b>](https://github.com/sponsorCoinAdmin/Breadcrumbs      SPCOIN-PROJECT-MODULES/blob/main/scripts/spCoinSetup.sh)  ~ This file is to be run from the scripts directory and downloads the [<b>Breadcrumbs      SPCOIN-PROJECT-MODULES</b>](https://github.com/sponsorCoinAdmin/Breadcrumbs      SPCOIN-PROJECT-MODULES/tree/main</b>) repository to local. Next it executes the [<b>spCoinEnvSetup.sh</b>](https://github.com/sponsorCoinAdmin/spCoinSetupEnv/blob/main/spCoinEnvSetup.sh) file for environment setup.
...
2. Running the test menu display, <b>'tm'</b>, command will list the testing options.
   Running the alias menu command <b>'hhtest'</b> will start the SPCOIN-PROJECT-MODULES package test.
 - - - -
...
<b>[![ToDo](https://github.com/sponsorCoinAdmin/spCoinImages/blob/main/maxresdefault.jpg)]</b>(https://youtu.be/T_d5-y8hpYI "<b>Breadcrumbs      SPCOIN-PROJECT-MODULES</b> ~ A brief overview")
